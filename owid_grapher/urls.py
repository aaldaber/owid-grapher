...
urlpatterns = [
    ...
    url(r'^grapher/admin/licenses/$', admin_views.listlicenses, name="listlicenses"),
    url(r'^grapher/admin/licenses/(?P<licenseid>[\w]+)/$', admin_views.showlicense, name="showlicense"),
    url(r'^grapher/admin/licenses/(?P<licenseid>[\w]+)$', admin_views.managelicense, name="managelicense"),
    url(r'^grapher/admin/licenses/(?P<licenseid>[\w]+)/edit/$', admin_views.editlicense, name="editlicense"),
    ...
    url(r'^grapher/admin/showvarsources/$', admin_views.display_owid_var_sources, name="displayowidvarsources"),
